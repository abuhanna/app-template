...
describe('UserStore', () => {
  ...
  describe('fetchUser', () => {
    it('updates selectedUser', async () => {
      ...
      vi.mocked(userApi.getUser).mockResolvedValue({ success: true, data: mockUser } as any)
  ...
  describe('createUser', () => {
    it('calls API and adds user to list', async () => {
      ...
      vi.mocked(userApi.createUser).mockResolvedValue({ success: true, data: newUser } as any)
  ...
  describe('updateUser', () => {
    it('calls API and updates user in list', async () => {
      ...
      vi.mocked(userApi.updateUser).mockResolvedValue({ success: true, data: updatedUser } as any)
