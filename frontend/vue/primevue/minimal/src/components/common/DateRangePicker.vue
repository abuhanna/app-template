  ...
  <div class="date-range-picker">
    <div class="flex flex-wrap align-items-center gap-3">
      ...
      <div class="flex flex-column gap-1">
        <label v-if="showLabels" class="text-sm font-medium" :for="fromId">{{ fromLabel }}</label>
        <DatePicker
          :id="fromId"
          v-model="fromDate"
          :class="inputClass"
      ...
      <!-- To Date -->
      <div class="flex flex-column gap-1">
        <label v-if="showLabels" class="text-sm font-medium" :for="toId">{{ toLabel }}</label>
        <DatePicker
          :id="toId"
          v-model="toDate"
          :class="inputClass"
...
<script setup>
  ...
  const fromId = `from-date-${Math.random().toString(36).slice(2, 9)}`
  const toId = `to-date-${Math.random().toString(36).slice(2, 9)}`
