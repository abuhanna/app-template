...
describe('Persistent Notification Store', () => {
  ...
  describe('handleNotification', () => {
    it('prepends notification to the list', () => {
      ...
      // Access the internal method through the store - handleNotification is not exported
      // but we can test the behavior indirectly. Since it's internal, let's test via
      // the notification being added.
  ...
  describe('initSignalR', () => {
    it('returns early when no token', async () => {
      ...
      // Should not have set connection since authStore.token is null
