# AppTemplate - Fullstack NestJS + Vue

This project was generated using [`create-apptemplate`](https://github.com/abuhannaa/app-template). It features a **NestJS** backend and a **Vue 3** frontend, pre-configured for containerized deployment.
...
- **Architecture**: Modular with CQRS
- **Auth**: JWT Passport
