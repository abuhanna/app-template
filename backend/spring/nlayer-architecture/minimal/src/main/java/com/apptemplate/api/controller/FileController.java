...
public class FileController {
    ...
    public ResponseEntity<PagedResult<UploadedFileDto>> getFiles(
        ...
        Page<UploadedFileDto> files = fileService.getFiles(page, pageSize, search, sortBy, sortOrder, category, isPublic);
        return ResponseEntity.ok(PagedResult.from(files));
    }
