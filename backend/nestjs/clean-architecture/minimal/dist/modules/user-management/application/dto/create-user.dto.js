...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'john.doe@example.com', description: 'Email address' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Password@123', description: 'Password' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: user_role_1.UserRole, example: user_role_1.UserRole.User, description: 'User role' }),
