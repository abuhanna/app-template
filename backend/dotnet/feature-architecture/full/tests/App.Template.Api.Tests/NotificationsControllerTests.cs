...
public class NotificationsControllerTests
{
    ...
    public async Task GetAll_ReturnsOk_WithPaginatedNotifications()
    {
        ...
        _mockNotificationService.Setup(s => s.GetNotificationsAsync(1L, queryParams)).ReturnsAsync(notifications);
    ...
    {
        _mockNotificationService.Setup(s => s.GetUnreadCountAsync(1L)).ReturnsAsync(5);
    ...
    {
        _mockNotificationService.Setup(s => s.DeleteAsync(1, 1L)).ReturnsAsync(false);
