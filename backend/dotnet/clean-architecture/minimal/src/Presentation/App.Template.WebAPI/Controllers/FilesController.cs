...
public class FilesController : ControllerBase
{
    ...
    /// </summary>
    [HttpGet]
    [ProducesResponseType(typeof(ApiResponse<List<UploadedFileDto>>), StatusCodes.Status200OK)]
        ...
        [FromQuery] int pageSize = 20)
    {
        ...
        return Ok(ApiResponse.Ok(result, "Files retrieved successfully"));
    }
    ...
    public async Task<IActionResult> GetFile(long id)
    {
        ...
        return Ok(ApiResponse.Ok(result, "File retrieved successfully"));
    }
        ...
        [FromForm] bool isPublic = false)
    {
        ...
        return CreatedAtAction(nameof(GetFile), new { id = result.Id }, ApiResponse.Ok(result, "File uploaded successfully"));
    }
